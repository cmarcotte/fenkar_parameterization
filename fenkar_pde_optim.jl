...
plt.colorbar()
plt.savefig("./pde/optim/baseline.pdf")
plt.close()
...
lower = [  1.0,  10.0,  400.0,   2.33, 10.0,  100.0, 0.10, 10.0,  10.0,  9.0, 0.10, 0.01,  0.10, -0.3,  0.0, 100.0, 0.0]
upper = [ 50.0,  50.0, 2000.0,   4.33, 50.0, 1000.0, 0.50, 50.0,  50.0, 11.0, 0.90, 0.90,  0.90,  0.3, t[1], 150.0, 1.0]
...
plt.savefig("./pde/optim/$(ind)_fittings.pdf")
plt.close()

open("./pde/optim/$(ind)_params.txt", "w") do io
