...
using .exportData, DifferentialEquations, DiffEqParamEstim, PyPlot, BlackBoxOptim, Optim, DelimitedFiles
...
t, data, p[15] = getExpData(ind; xInds=[48,64,72], tInds=1:250) # positions = [ 2.52, 3.84, 4.20 ] -> [168,256,280]
#p[14] = -20.0 # this is pretty manual; how to automate?
pp = readdlm("./pde/bbo/$(ind)_params.txt")
p .= pp[end,:]
...
# fit
result = bboptimize(cost_function; SearchRange = bound, MaxSteps = 10000) #, NThreads=Threads.nthreads()-1)
@info "Initial p = $(p) \n"
